...
<div class="dark:bg-gray-800 h-auto justify-center
    ...
    <div class="max-w-5xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        <h1 class="text-2xl font-bold text-center mb-6 text-gray-800">تبادل لینک شبکه اجتماعی</h1>
...
<div id="pos-article-text-card-106821"></div>
        ...
        <br><br>
        <h1><strong>پیج های آماده تبادل ({{$count}})</strong></h1>
        <br><br>
                    ...
                    <div class="border border-sky-300 rounded-lg shadow-md overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-gray-500 text-sm">
                                ...
                                @endif
                                {{$link->social}}</p>
                            <h1 class="text-lg font-bold text-gray-800 mt-2">{{$link->name}}</h1>
