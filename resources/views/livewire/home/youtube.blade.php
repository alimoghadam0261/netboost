...
<div id="pos-article-text-card-106821"></div>
        ...
        <div class="flex justify-around">
            <a href="https://yt6d.com/en/"><button class="bg-red-400 p-2 rounded-md transition-all duration-500 hover:bg-red-600 hover:text-white">لینک اول دانلود از یوتوب</button></a>
            <a href="https://en.greenconvert.net/"><button class="bg-red-400 p-2 rounded-md transition-all duration-500 hover:bg-red-600 hover:text-white">لینک دوم دانلود از یوتوب</button></a>
            <a href="https://y2mate.nu/en-szSi/"><button class="bg-red-400 p-2 rounded-md transition-all duration-500 hover:bg-red-600 hover:text-white">لینک سوم دانلود از یوتوب</button></a>
        </div>
        <br>
        <div class="flex justify-around">
            <a href="https://snapins.ai/"><button class="bg-pink-400 p-2 rounded-md transition-all duration-500 hover:bg-pink-600 hover:text-white">لینک اول دانلود از اینستاگرام </button></a>
            <a href="https://igram.world/"><button class="bg-pink-400 p-2 rounded-md transition-all duration-500 hover:bg-pink-600 hover:text-white">لینک دوم دانلود از اینستاگرام </button></a>
            <a href="https://fastdl.app/en"><button class="bg-pink-400 p-2 rounded-md transition-all duration-500 hover:bg-pink-600 hover:text-white">لینک سوم دانلود از اینستاگرام </button></a>
        </div>
<br>
