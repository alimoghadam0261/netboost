<div>
    ...
    <div class="flex">
        ...
        <a class="bg-sky-100 bg-text-gray-400 py-1 rounded-md my-2 mx-1 h-[30px] transition-all duration-700 hover:text-white hover:bg-sky-300" wire:navigate href="{{route('musiceffect')}}">افکت صدا</a>
    </div>
    <br>
    ...
    transform    transition-all duration-700 ease-in-out shadow-lg">
        <div class="max-w-5xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
            <div class="max-w-5xl mx-auto py-10">
                <h1>
                    برای شما عزیزان لیستی از افکت های صدا تهیه شده است که می توانید به رایگان دانلود کنید
                </h1>
                <br>
                <p>
