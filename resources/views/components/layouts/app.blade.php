...
<script>
            !function(e,t,n){e.yektanetAnalyticsObject=n,e[n]=e[n]||function(){e[n].q.push(arguments)},e[n].q=e[n].q||[];var a=t.getElementsByTagName("head")[0],r=new Date,c="https://cdn.yektanet.com/superscript/wafIVwEZ/native-netboost.ir-42722/yn_pub.js?v="+r.getFullYear().toString()+"0"+r.getMonth()+"0"+r.getDate()+"0"+r.getHours(),s=t.createElement("link");s.rel="preload",s.as="script",s.href=c,a.appendChild(s);var l=t.createElement("script");l.async=!0,l.src=c,a.appendChild(l)}(window,document,"yektanet");
        </script>
...
<link id="canonical" rel="canonical" href="{{ url()->current() }}">
  ...
  ,سایت,تولید,لینک,دانلود,ویدیو,آموزش,حمایت,تبادل
    ...
    <meta property="og:description" content="با NetBoost، بیش از 30 خدمت رایگان برای رشد صفحه مجازی خود دریافت کنید، از جمله تولید هشتگ، ترندهای روز، موزیک‌های ترند، ویدیوهای هوک و دیگر خدمات." />
    <meta property="og:url" content="https://netboost.ir" />
    <meta property="og:type" content="website" />
    <meta property="og:image" content="https://netboost.ir/public/img/share.jpg" /> <!-- آدرس تصویری که می‌خواهید در اشتراک‌گذاری‌ها نمایش داده شود -->
...
<meta name="copyright" content="© 2025 Ariyabod Group. All rights reserved.">
    ...
    <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent"> <!-- تنظیم نوار وضعیت در دستگاه‌های اپل -->
...
<div class="donate-mobile fixed bottom-[4%] right-[1%] pt-[5px] transition-all duration-700">
    <a wire:navigate.hover href="{{route('donate')}}">
        <img class="rounded-[50%] img-spanser" src="{{asset('./img/defult/webp/tifa.webp')}}" alt="spanser" loading="eager" height="80"  width="80">
        <p class="text-[14px] mx-[10px]">اسپانسر</p>
    </a>
    <div class="spanser p-3">
        <img class="mx-[90px]" src="{{asset('./img/defult/webp/tifa.webp')}}" alt="spanser1" loading="eager" height="200"  width="200"><br>
        <h2 class="text-[20px] text-center"> <strong>tifa_underwear</strong> <i class="fa-brands fa-instagram text-gray-800 text-[25px]"></i></h1><br>
